  ...
  return (
    <div className="app-home">
      ...
      <Link to="/text-extraction" className="nav-link">Text Extraction</Link>
        ...
        <Link to="/excel-to-text" className="nav-link nav-active">Excel</Link>
      </Navbar>
        ...
        <section className="main-section image2text-section">
          <div className="image2text-left">
            <form className="file-uploader-card glassmorph-uploader" onSubmit={handleUpload}>
              ...
              <h2>Excel to Text</h2>
              <input type="file" accept=".xls,.xlsx,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" className="file-input fancy-input" onChange={handleFileChange} />
              ...
              <p className="file-uploader-desc">Select an Excel file to extract text from.</p>
