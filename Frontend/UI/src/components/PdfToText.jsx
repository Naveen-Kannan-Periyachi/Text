  ...
  return (
    <div className="app-home">
      ...
      <Link to="/text-extraction" className="nav-link">Text Extraction</Link>
        ...
        <Link to="/pdf-to-text" className="nav-link nav-active">PDF</Link>
        ...
        <section className="main-section image2text-section">
          <div className="image2text-left">
            <form className="file-uploader-card glassmorph-uploader" onSubmit={handleUpload}>
              ...
              <h2>PDF to Text</h2>
              <input type="file" accept="application/pdf" className="file-input fancy-input" onChange={handleFileChange} />
              ...
              <p className="file-uploader-desc">Select a PDF file to extract text from.</p>
